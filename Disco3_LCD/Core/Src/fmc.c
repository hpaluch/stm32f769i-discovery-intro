...
/* USER CODE BEGIN 0 */
// required initialization from: c:\Ac6\STM32Cube_FW_F7_V1.17.0\Drivers\BSP\STM32F769I-Discovery\stm32f769i_discovery_sdram.c
#define APP_REFRESH_COUNT                    ((uint32_t)0x0603)   /* SDRAM refresh counter (100Mhz SD clock) */
...
/**
  ...
  * @retval None
  */
static void APP_BSP_SDRAM_Initialization_sequence(uint32_t RefreshCount)
{
...
void MX_FMC_Init(void)
{
  ...
  */
  ...
  APP_BSP_SDRAM_Initialization_sequence(APP_REFRESH_COUNT);
